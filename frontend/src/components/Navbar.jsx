...
import { LayoutDashboard, ReceiptText, Wallet, LogOut, TrendingUp, PiggyBank, UserCircle, Sun, Moon, Sparkles } from 'lucide-react';
        ...
        <nav className="fixed top-0 left-0 right-0 h-16 glass flex items-center justify-between px-8 z-50">
            ...
            {user && (
                <div className="flex items-center gap-8">
                    ...
                    <Link to="/assistant" className="flex items-center gap-2 text-emerald-400 hover:text-emerald-300 transition-colors bg-emerald-500/10 px-3 py-1.5 rounded-xl border border-emerald-500/20">
